...
public class ViewOpenPostions extends javax.swing.JDialog {
     ...
     */
    public ViewOpenPostions(javax.swing.JDialog parent, boolean modal, User loggedInUser) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        formTitle.setText("Open Positions");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewOpenPostions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewOpenPostions dialog = new ViewOpenPostions(new javax.swing.JDialog(), true, loggedInUserGlobal);
    ...
    public void addStockData(){
        if (loggedInUserGlobal != null) {
            ...
            for(int i=0; i<customer.getOpenPositions().size(); i++){
                ...
                vector.add(customer.getOpenPositions().get(i).getStockTransactionId());
                vector.add(customer.getOpenPositions().get(i).getStockId());
                vector.add(customer.getOpenPositions().get(i).getAccountNumber());
                vector.add(customer.getOpenPositions().get(i).getQuantity());
                vector.add(customer.getOpenPositions().get(i).getStatus());
                vector.add(customer.getOpenPositions().get(i).getBuyPrice());
                vector.add(customer.getOpenPositions().get(i).getSellPrice());
                vector.add(customer.getOpenPositions().get(i).getTransactionDate());
                model.addRow(vector);
            }
//            System.out.println(customer.getOpenPositions());
            manager.loadAllData();
            loggedInUserGlobal = manager.getLoggedInUser(loggedInUserGlobal.getId());
