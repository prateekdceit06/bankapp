 ...
 */
public class InactiveUsers extends javax.swing.JDialog {

    static User loggedInUserGlobal;
    /**
     * Creates new form GetUserByUserID
     */
    public InactiveUsers(javax.swing.JDialog parent, boolean modal, User loggedInUser) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        formTitle.setText("Inactive Users");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InactiveUsers dialog = new InactiveUsers(new javax.swing.JDialog(), true, loggedInUserGlobal);
