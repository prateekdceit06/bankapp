...
public class ViewStockTransactions extends javax.swing.JDialog {
     ...
     */
    public ViewStockTransactions(javax.swing.JDialog parent, boolean modal, User loggedInUser) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewStockTransactions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewStockTransactions dialog = new ViewStockTransactions(new javax.swing.JDialog(), true, loggedInUserGlobal);
