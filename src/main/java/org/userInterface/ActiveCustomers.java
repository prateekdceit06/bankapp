...
public class ActiveCustomers extends javax.swing.JDialog {
     ...
     */
    public ActiveCustomers(javax.swing.JDialog parent, boolean modal, User loggedInUser) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActiveCustomers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ActiveCustomers dialog = new ActiveCustomers(new javax.swing.JDialog(), true, loggedInUserGlobal);
