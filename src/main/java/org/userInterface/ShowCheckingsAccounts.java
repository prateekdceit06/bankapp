 ...
 */
public class ShowCheckingsAccounts extends javax.swing.JDialog {
    ...
    private javax.swing.JTable checkingsAccounts;
     ...
     */
    public ShowCheckingsAccounts(javax.swing.JDialog parent, boolean modal, User loggedInUser) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        checkingsAccounts = new javax.swing.JTable();
        ...
        formTitle.setText("Checkings Accounts Information");
        ...
        checkingsAccounts.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane4.setViewportView(checkingsAccounts);
    ...
    private void closeActionPerformed(java.awt.event.ActionEvent evt) {
        if (loggedInUserGlobal != null) {
            ...
            DefaultTableModel model =(DefaultTableModel) checkingsAccounts.getModel();
            int selectedRow = checkingsAccounts.getSelectedRow();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowCheckingsAccounts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ShowCheckingsAccounts dialog = new ShowCheckingsAccounts(new javax.swing.JDialog(), true, loggedInUserGlobal);
