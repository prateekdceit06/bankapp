 ...
 */
public class LoanApplicationStatus extends javax.swing.JDialog {

    static User loggedInUserGlobal;
    /**
     * Creates new form TransferFunds
     */
    public LoanApplicationStatus(javax.swing.JDialog parent, boolean modal, User loggedInUser) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        formTitle.setText("Loan Application Status");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoanApplicationStatus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LoanApplicationStatus dialog = new LoanApplicationStatus(new javax.swing.JDialog(), true, loggedInUserGlobal);
