...
public class GetUserByUserID extends javax.swing.JDialog {
     ...
     */
    public GetUserByUserID(javax.swing.JDialog parent, boolean modal, User loggedInUser) {
        super(parent, modal);
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (loggedInUserGlobal != null) {
            ...
            if (loggedInUserGlobal.getIsAdmin() == 1) {
                ...
                id = Integer.parseInt(customerIdValue.getText());
            } else {
                id = loggedInUserGlobal.getId();
            }
            ...
            if(!found){
                JOptionPane.showMessageDialog(null, "No user found with this customer ID");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GetUserByUserID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GetUserByUserID dialog = new GetUserByUserID(new javax.swing.JDialog(), true, loggedInUserGlobal);
