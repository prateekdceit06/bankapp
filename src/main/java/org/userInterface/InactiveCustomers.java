...
public class InactiveCustomers extends javax.swing.JDialog {
     ...
     */
    public InactiveCustomers(javax.swing.JDialog parent, boolean modal, User loggedInUser) {
        super(parent, modal);
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {                                       
        //clear the table
        DefaultTableModel accountModel = (DefaultTableModel)jTable3.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InactiveCustomers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InactiveCustomers dialog = new InactiveCustomers(new javax.swing.JDialog(), true, loggedInUserGlobal);
